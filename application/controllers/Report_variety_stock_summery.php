...
class Report_variety_stock_summery extends Root_Controller
{
    public $message;
    public $permissions;
    ...
    public function __construct()
    {
        parent::__construct();
        $this->message="";
        $this->permissions=User_helper::get_permission('Report_variety_stock_summery');
        $this->controller_url='report_variety_stock_summery';
    }
    ...
    private function system_search()
    {
        if(isset($this->permissions['action0'])&&($this->permissions['action0']==1))
        {
            ...
            $data['title']="Variety Stock Summery Report Search";
            $ajax['status']=true;
