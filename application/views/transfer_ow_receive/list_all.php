    ...
    $(document).ready(function ()
    {
        ...
        var source =
        {
            ...
            dataFields: [
                ...
                { name: 'time_approved', type: 'string'},
                { name: 'date_delivery', type: 'string'},
                { name: 'time_delivery', type: 'string'},
        ...
        $("#system_jqx_container").jqxGrid(
        {
            ...
            [
                ...
                { text: '<?php echo $CI->lang->line('LABEL_OUTLET_NAME'); ?>', dataField: 'outlet_name',pinned:true, width:'150',filtertype: 'list',hidden: <?php echo $system_preference_items['outlet_name']?0:1;?>},
                { text: '<?php echo $CI->lang->line('LABEL_TIME_DELIVERY'); ?>', dataField: 'time_delivery', width:'200',hidden: <?php echo $system_preference_items['time_delivery']?0:1;?>},
                ...
                { text: '<?php echo $CI->lang->line('LABEL_TIME_APPROVED'); ?>', dataField: 'time_approved', width:'200',hidden: <?php echo $system_preference_items['time_approved']?0:1;?>},
