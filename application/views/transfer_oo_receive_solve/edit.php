    ...
    <div class="row widget">
                ...
                <table class="table table-bordered">
                    ...
                    foreach($items as $index=>$value)
                    {
                        ...
                        <tr class='<?php if($quantity_approve!=$quantity_receive){echo 'bg-danger';}?>'>
                            ...
                            <td class="text-right">
                                <label> <?php echo System_helper::get_string_kg($quantity_approve_kg);?> </label>
                            </td>
                            <td class="text-right">
                                <label><?php echo System_helper::get_string_quantity($quantity_receive); ?></label>
                            </td>
                            <td class="text-right">
                                <label> <?php echo System_helper::get_string_kg($quantity_receive_kg);?> </label>
                            </td>
                            <td class="text-right">
                                <label> <?php echo System_helper::get_string_quantity($quantity_difference); ?> </label>
                            </td>
                            <td class="text-right">
                                <label> <?php echo System_helper::get_string_kg($quantity_difference_kg); ?> </label>
                            </td>
                        </tr>
                    <?php
                    }
                    ...
                    <tr>
                        ...
                        <th class="text-right"><label class="control-label" id="quantity_total_receive_kg"> <?php echo System_helper::get_string_kg($quantity_total_receive_kg);?></label></th>
                        <th class="text-right"><label class="control-label" id="stock_quantity_total_new"> <?php echo System_helper::get_string_quantity($quantity_total_difference);?></label></th>
                        <th class="text-right"><label class="control-label" id="stock_quantity_total_new_kg"> <?php echo System_helper::get_string_kg($quantity_total_difference_kg);?></label></th>
                    </tr>
                    </tfoot>
                </table>
            </div>
        ...
        if($item['remarks_receive_approve'])
        {
            ...
            <div class="row show-grid">
                ...
                <div class="col-sm-4 col-xs-8">
                    <label for=""><?php echo nl2br($item['remarks_receive_approve']);?></label>
                </div>
            </div>
        <?php
        }
