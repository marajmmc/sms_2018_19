                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <label class="control-label stock_available" id="stock_available_<?php echo $index+1;?>">
                                        <?php echo isset($too_variety_info[$value['variety_id']][$value['pack_size_id']])?number_format($too_variety_info[$value['variety_id']][$value['pack_size_id']]['stock_available'],3,'.',''):'0.000'; ?>
                                    </label>
                                </td>
                                <td>
    ...
    $(document).ready(function()
    {
        ...
        $(document).on("change","#items_container .pack_size_id",function()
        {
            ...
            if(too_variety_info[variety_id][pack_size_id]!==undefined)
            {
                ...
                $("#stock_available_"+current_id).html(number_format(too_variety_info[variety_id][pack_size_id]['stock_available'],3,'.',''));
