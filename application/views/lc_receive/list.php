...
<div class="row widget">
    ...
    if(isset($CI->permissions['action6']) && ($CI->permissions['action6']==1))
    {
        ...
        <div class="col-xs-12" style="margin-bottom: 20px;">
            ...
            <div class="col-xs-2">
                <div class="checkbox">
                    <label><input type="checkbox" class="system_jqx_column" value="quantity_total_release_kg" <?php if($items['quantity_total_release_kg']){echo 'checked';}?> value="1"><span class="label label-success">Release (KG)</span></label>
                </div>
            </div>
            <div class="col-xs-2">
                <div class="checkbox">
                    <label><input type="checkbox" class="system_jqx_column" value="quantity_total_receive_kg" <?php if($items['quantity_total_receive_kg']){echo 'checked';}?> value="1"><span class="label label-success">Receive (KG)</span></label>
                </div>
            </div>
            <div class="col-xs-2">
                <div class="checkbox">
                    <label><input type="checkbox" class="system_jqx_column" value="status_receive" <?php if($items['status_receive']){echo 'checked';}?> value="1"><span class="label label-success"><?php echo $this->lang->line('STATUS')?></span></label>
                </div>
            </div>
        </div>
    <?php
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns:
                    [
                        ...
                        { text: 'Release (KG)', dataField: 'quantity_total_release_kg', width:100, cellsalign: 'right',  hidden: <?php echo $items['quantity_total_release_kg']?0:1;?>},
                        { text: 'Receive (KG)', dataField: 'quantity_total_receive_kg', width:100, cellsalign: 'right', hidden: <?php echo $items['quantity_total_receive_kg']?0:1;?>},
                        { text: '<?php echo $this->lang->line('STATUS')?>', dataField: 'status_receive',cellsalign: 'center',filtertype: 'list', width:65, hidden: <?php echo $items['status_receive']?0:1;?>}
                    ]
            });
    });
</script>
