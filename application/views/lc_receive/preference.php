...
<form class="form_valid" id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save_preference');?>" method="post">
    ...
    <div class="row widget">
        ...
        <div style="" class="row show-grid">
            ...
            <div class="col-xs-2">
                <div class="checkbox">
                    <label><input type="checkbox" name="items[price_other_cost_total_receive_currency]" <?php if($items['price_other_cost_total_receive_currency']){echo 'checked';}?> value="1"><span class="label label-success"><?php echo $CI->lang->line('LABEL_OTHER_COST_CURRENCY'); ?></span></label>
                </div>
            </div>
            <div class="col-xs-2">
                <div class="checkbox">
                    <label><input type="checkbox" name="items[quantity_total_receive_kg]" <?php if($items['quantity_total_receive_kg']){echo 'checked';}?> value="1"><span class="label label-success">KG</span></label>
                </div>
            </div>
            <div class="col-xs-2">
                <div class="checkbox">
                    <label><input type="checkbox" name="items[price_variety_total_receive_currency]" <?php if($items['price_variety_total_receive_currency']){echo 'checked';}?> value="1"><span class="label label-success">Variety (Currency)</span></label>
                </div>
            </div>
            <div class="col-xs-2">
                <div class="checkbox">
                    <label><input type="checkbox" name="items[price_total_receive_currency]" <?php if($items['price_total_receive_currency']){echo 'checked';}?> value="1"><span class="label label-success"><?php echo $CI->lang->line('LABEL_TOTAL_CURRENCY'); ?></span></label>
                </div>
            </div>
            <div class="col-xs-2">
                <div class="checkbox">
                    <label><input type="checkbox" name="items[status_receive]" <?php if($items['status_receive']){echo 'checked';}?> value="1"><span class="label label-success"><?php echo $this->lang->line('STATUS')?></span></label>
                </div>
            </div>
        </div>
