    ...
    $(document).ready(function ()
    {
        ...
        var source =
        {
            ...
            dataFields: [
                ...
                { name: 'quantity_total_pieces', type: 'string' },
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_QUANTITY_TOTAL_PIECES'); ?>', cellsalign: 'right',dataField: 'quantity_total_pieces',width:'100',hidden: <?php echo $system_preference_items['quantity_total_pieces']?0:1;?>},
