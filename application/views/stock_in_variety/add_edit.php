            ...
            else
            {
                ...
                <div class="col-sm-4 col-xs-8">
                    <select id="purpose" name="item[purpose]" class="form-control">
                        ...
                        <option value="<?php echo $CI->config->item('system_purpose_variety_in_delivery_short');?>" <?php if(isset($item['purpose'])){if($item['purpose']==$CI->config->item('system_purpose_variety_in_delivery_short')){echo "selected";}}?>><?php echo $CI->lang->line('LABEL_STOCK_IN_DELIVERY_SHORT');?></option>
                    </select>
                </div>
            <?php } ?>
        </div>
