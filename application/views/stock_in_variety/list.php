        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_QUANTITY_TOTAL_KG'); ?>', cellsalign: 'right',dataField: 'quantity_total_kg',width:'200',hidden: <?php echo $system_preference_items['quantity_total_kg']?0:1;?>},
