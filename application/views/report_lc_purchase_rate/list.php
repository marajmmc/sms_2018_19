...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        var cellsrenderer = function(row, column, value, defaultHtml, columnSettings, record)
        {
            ...
            else if(column.substr(0,4)=='rate')
            {
                if(value==0)
                {
                    element.html('');
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_STOCK_TOTAL_PKT'); ?>', dataField: 'stock_total_pkt',width:'100',cellsalign: 'right',cellsrenderer: cellsrenderer,hidden: <?php echo $system_preference_items['stock_total_pkt']?0:1;?>,aggregates: [{ 'total':aggregates}],aggregatesrenderer:aggregatesrenderer_kg},
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_RATE_WEIGHTED_RECEIVE'); ?>', dataField: 'rate_weighted_receive',width:'100',cellsalign: 'right',cellsrenderer: cellsrenderer,hidden: <?php echo $system_preference_items['rate_weighted_receive']?0:1;?>,aggregates: [{ 'total':aggregates}],aggregatesrenderer:aggregatesrenderer_amount},
                    { text: '<?php echo $CI->lang->line('LABEL_AMOUNT_TOTAL_RATE_RECEIVE'); ?>', dataField: 'amount_total_rate_receive',width:'100',cellsalign: 'right',cellsrenderer: cellsrenderer,hidden: <?php echo $system_preference_items['amount_total_rate_receive']?0:1;?>,aggregates: [{ 'total':aggregates}],aggregatesrenderer:aggregatesrenderer_amount},
                    { text: '<?php echo $CI->lang->line('LABEL_RATE_WEIGHTED_COMPLETE'); ?>', dataField: 'rate_weighted_complete',width:'100',cellsalign: 'right',cellsrenderer: cellsrenderer,hidden: <?php echo $system_preference_items['rate_weighted_complete']?0:1;?>,aggregates: [{ 'total':aggregates}],aggregatesrenderer:aggregatesrenderer_amount},
                    { text: '<?php echo $CI->lang->line('LABEL_AMOUNT_TOTAL_RATE_COMPLETE'); ?>', dataField: 'amount_total_rate_complete',width:'100',cellsalign: 'right',cellsrenderer: cellsrenderer,hidden: <?php echo $system_preference_items['amount_total_rate_complete']?0:1;?>,aggregates: [{ 'total':aggregates}],aggregatesrenderer:aggregatesrenderer_amount}
