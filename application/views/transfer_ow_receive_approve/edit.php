        ...
        <div class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-4">
                <div class="action_button pull-right">
                    <button id="button_action_save" type="button" class="btn" data-form="#save_form" data-message-confirm="Are You Sure Outlet to HQ transfer receive approve done?">Save</button>
                </div>
            </div>
            <div class="col-sm-4 col-xs-4">
