...
<form id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save');?>" method="post">
    ...
    <div class="row widget">
                ...
                <table class="table table-bordered">
                    ...
                    foreach($items as $index=>$value)
                    {
                        ...
                        <tr class='<?php if($quantity_approve!=$quantity_receive){echo 'quantity_exist_warning';}?>'>
                            ...
                            <td class="text-right">
                                <label> <?php echo $quantity_difference; ?> </label>
                            </td>
                            <td class="text-right">
        ...
        <div class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="status_receive_approve" class="form-control" name="item[status_receive_approve]">
        ...
        <div class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <textarea name="item[remarks_receive_approve]" id="remarks_receive_approve" class="form-control"><?php echo $item['remarks_receive_approve'];?></textarea>
            </div>
        </div>
        <div class="row show-grid">
            <div class="col-xs-4">
            ...
            <div class="col-sm-4 col-xs-4">
                <div class="action_button">
                    <button id="button_action_save" type="button" class="btn" data-form="#save_form" data-message-confirm="Are You Sure HQ to outlet transfer receive approve done?">HQ to Outlet `TO` Receive Approved</button>
                </div>
            </div>
            <div class="col-sm-4 col-xs-4">
