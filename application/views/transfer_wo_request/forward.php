...
<form id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save_forward');?>" method="post">
    ...
    <div class="row widget">
        ...
        <div class="row show-grid">
            <div class="col-xs-4">
                <label class="control-label pull-right"><?php echo $this->lang->line('LABEL_TO_FORWARD');?><span style="color:#FF0000">*</span></label>
            </div>
        ...
        <div class="col-md-12">
            <table class="table table-bordered table-responsive system_table_details_view">
                ...
                <tr>
                    ...
                    <th class=" header_value"><label class="control-label"><?php echo $CI->locations['division_name'];?></label></th>
                    <th colspan="2">&nbsp;</th>
                </tr>
                <tr>
                    ...
                    <th class=" header_value"><label class="control-label"><?php echo $CI->locations['zone_name'];?></label></th>
                    <th colspan="2">&nbsp;</th>
                </tr>
                <tr>
                    ...
                    <th class=" header_value"><label class="control-label"><?php echo $CI->locations['territory_name'];?></label></th>
                    <th colspan="2">&nbsp;</th>
                </tr>
                <tr>
                    ...
                    <th class=" header_value"><label class="control-label"><?php echo $CI->locations['district_name'];?></label></th>
                    <th colspan="2">&nbsp;</th>
                </tr>
                <tr>
                ...
                if($item['remarks_request'])
                {
                    ?>
                    <tr>
                        <th class="widget-header header_caption" style="vertical-align: top"><label class="control-label pull-right"><?php echo $this->lang->line('LABEL_REMARKS_TO_REQUEST');?></label></th>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <label class="control-label stock_outlet" id="stock_outlet_<?php echo $index+1;?>">
                                    <?php
                                    echo isset($two_variety_info[$value['variety_id']][$value['pack_size_id']])?$two_variety_info[$value['variety_id']][$value['pack_size_id']]['stock_outlet']:'';
                                    ?>
                                </label>
                            </td>
                            <td class="text-right">
                                <label class="control-label quantity_max_transferable" id="quantity_max_transferable_<?php echo $index+1;?>">
                                    <?php
                                    echo isset($two_variety_info[$value['variety_id']][$value['pack_size_id']])?$two_variety_info[$value['variety_id']][$value['pack_size_id']]['quantity_max_transferable']:'';
                                    ?>
                                </label>
                            </td>
                            <?php
