...
<div class="row widget">
    ...
    <div class="col-xs-12" style="margin-bottom: 20px;">
        <div class="col-xs-12" style="margin-bottom: 20px;">
            ...
            <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column" checked value="supplier_name"><?php echo $CI->lang->line('LABEL_SUPPLIER'); ?></label>
            <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column" checked value="quantity_total_receive"><?php echo $CI->lang->line('LABEL_QUANTITY_TOTAL'); ?></label>
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_DATE_PURCHASE'); ?>', filtertype: 'list',dataField: 'date_purchase',width:'140'},
                    { text: '<?php echo $CI->lang->line('LABEL_SUPPLIER'); ?>', filtertype: 'list',dataField: 'supplier_name',width:'140'},

                    { text: '<?php echo $CI->lang->line('LABEL_QUANTITY_TOTAL'); ?> (KG)', cellsalign: 'right',dataField: 'quantity_total_receive',width:'200'},
