...
<form id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save');?>" method="post">
    ...
    <div class="row widget">
        ...
        <div style="" class="row show-grid">
            <div class="col-xs-4">
                <label class="control-label pull-right"><?php echo $CI->lang->line('LABEL_SUPPLIER');?><span style="color:#FF0000">*</span></label>
            </div>
            <div class="col-sm-4 col-xs-8">
            ...
            <table class="table table-bordered">
                ...
                foreach($purchase_master as $index=>$master)
                {
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <input type="text" id="quantity_supply<?php echo $index+1;?>" value="<?php echo $master['quantity_supply']; ?>" class="form-control text-right float_type_positive quantity_supply" data-current-id="<?php echo $index+1;?>" name="items[<?php echo $index+1;?>][quantity_supply]">
                        </td>
                        <td class="text-right">
                            <input type="text" id="quantity_receive<?php echo $index+1;?>" value="<?php echo $master['quantity_receive']; ?>" class="form-control text-right float_type_positive quantity_receive" data-current-id="<?php echo $index+1;?>" name="items[<?php echo $index+1;?>][quantity_receive]">
                        </td>
                    </tr>
                <?php
                }
