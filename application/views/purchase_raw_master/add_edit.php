    ...
    <div class="row widget">
        ...
        <div class="row show-grid">
            <div class="row show-grid">
                ...
                <div class="col-sm-4 col-xs-8">
                    <input type="text" name="item[date_challan]" class="form-control datepicker" value="<?php echo System_helper::display_date($item['date_challan']);?>" readonly/>
                </div>
            </div>
        </div>
            ...
            <table class="table table-bordered">
                ...
                foreach($purchase_master as $index=>$master)
                {
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <label><?php $current_stock=Stock_helper::get_raw_stock(array($master['variety_id'])); if(isset($current_stock)){echo $current_stock[$master['variety_id']][$master['pack_size_id']][$CI->config->item('system_master_foil')]['current_stock'];}else{echo 0;}?></label>
                        </td>
                        <td class="text-right">
                        ...
                        <td class="text-right">
                            <input type="text" id="quantity_receive_<?php echo $index+1;?>" value="<?php echo $master['quantity_receive']; ?>" class="form-control text-right float_type_positive quantity_receive" data-current-id="<?php echo $index+1;?>" name="items[<?php echo $index+1;?>][quantity_receive]">
                        </td>
                        <td>
                            <input type="text" value="<?php echo $master['price_unit_tk']; ?>" class="form-control float_type_positive price_unit_tk" id="price_unit_tk_<?php echo $index+1;?>" data-current-id="<?php echo $index+1;?>" name="items[<?php echo $index+1;?>][price_unit_tk]">
                        </td>
                        <td class="text-right">
        ...
        <div class="row show-grid">
            ...
            <div class="col-xs-4">
                <button type="button" class="btn btn-warning system_button_add_more" data-current-id="<?php echo sizeof($purchase_master);?>"><?php echo $CI->lang->line('LABEL_ADD_MORE');?></button>
            </div>
            <div class="col-xs-4">
