...
<div class="row widget">
    ...
    <div class="col-xs-12" style="margin-bottom: 20px;">
        <div class="col-xs-12" style="margin-bottom: 20px;">
            ...
            <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column" checked value="quantity_receive"><?php echo $CI->lang->line('LABEL_QUANTITY'); ?></label>
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_QUANTITY'); ?> (KG)', cellsalign: 'right',dataField: 'quantity_receive',width:'200'},
