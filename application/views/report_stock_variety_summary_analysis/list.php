    ...
    $(document).ready(function ()
    {
        ...
        var source =
        {
            ...
            dataFields: [
                ...
                { name: 'in_stock_in_pkt', type: 'string' },
                { name: 'in_stock_in_kg', type: 'string' },
                { name: 'in_stock_excess_pkt', type: 'string' },
                { name: 'in_stock_excess_kg', type: 'string' },
                { name: 'in_stock_delivery_short_pkt', type: 'string' },
                { name: 'in_stock_delivery_short_kg', type: 'string' },
                { name: 'in_ww_pkt', type: 'string' },
                { name: 'in_ww_kg', type: 'string' },
                { name: 'in_ow_pkt', type: 'string' },
                { name: 'in_ow_kg', type: 'string' },
                { name: 'in_convert_bulk_pack_pkt', type: 'string' },
                { name: 'in_convert_bulk_pack_kg', type: 'string' },
                { name: 'in_lc_pkt', type: 'string' },
                { name: 'in_lc_kg', type: 'string' },
                { name: 'out_stock_sample_pkt', type: 'string' },
                { name: 'out_stock_sample_kg', type: 'string' },
                { name: 'out_stock_rnd_pkt', type: 'string' },
                { name: 'out_stock_rnd_kg', type: 'string' },
                { name: 'out_stock_demonstration_pkt', type: 'string' },
                { name: 'out_stock_demonstration_kg', type: 'string' },
                { name: 'out_stock_short_inventory_pkt', type: 'string' },
                { name: 'out_stock_short_inventory_kg', type: 'string' },
                { name: 'out_stock_delivery_excess_pkt', type: 'string' },
                { name: 'out_stock_delivery_excess_kg', type: 'string' },
                { name: 'out_convert_bulk_pack_kg', type: 'string' },
                { name: 'out_ww_pkt', type: 'string' },
                { name: 'out_ww_kg', type: 'string' },
                { name: 'out_wo_pkt', type: 'string' },
                { name: 'out_wo_kg', type: 'string' },
                { name: 'current_stock_pkt', type: 'string' },
                { name: 'current_stock_cal_pkt', type: 'string' },
                { name: 'current_stock_kg', type: 'string' },
                { name: 'current_stock_cal_kg', type: 'string' }
            ],
            id: 'id',
            type: 'POST',
            url: url,
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_IN_WW_PKT'); ?>', dataField: 'in_ww_pkt',width:'100',cellsalign: 'right',cellsrenderer: cellsrenderer,hidden: <?php echo $system_preference_items['in_ww_pkt']?0:1;?>,aggregates: [{ 'total':aggregates}],aggregatesrenderer:aggregatesrenderer},
                    { text: '<?php echo $CI->lang->line('LABEL_IN_WW_KG'); ?>', dataField: 'in_ww_kg',width:'100',cellsalign: 'right',cellsrenderer: cellsrenderer,hidden: <?php echo $system_preference_items['in_ww_kg']?0:1;?>,aggregates: [{ 'total':aggregates}],aggregatesrenderer:aggregatesrenderer},
                    { text: '<?php echo $CI->lang->line('LABEL_OUT_WW_PKT'); ?>', dataField: 'out_ww_pkt',width:'100',cellsalign: 'right',cellsrenderer: cellsrenderer,hidden: <?php echo $system_preference_items['out_ww_pkt']?0:1;?>,aggregates: [{ 'total':aggregates}],aggregatesrenderer:aggregatesrenderer},
                    { text: '<?php echo $CI->lang->line('LABEL_OUT_WW_KG'); ?>', dataField: 'out_ww_kg',width:'100',cellsalign: 'right',cellsrenderer: cellsrenderer,hidden: <?php echo $system_preference_items['out_ww_kg']?0:1;?>,aggregates: [{ 'total':aggregates}],aggregatesrenderer:aggregatesrenderer},
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_CURRENT_STOCK_CAL_PKT'); ?>', dataField: 'current_stock_cal_pkt',cellsrenderer: cellsrenderer,width:'100',cellsalign: 'right',hidden: <?php echo $system_preference_items['current_stock_cal_pkt']?0:1;?>,aggregates: [{ 'total':aggregates}],aggregatesrenderer:aggregatesrenderer},
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_CURRENT_STOCK_CAL_KG'); ?>', dataField: 'current_stock_cal_kg',cellsrenderer: cellsrenderer,width:'100',cellsalign: 'right',hidden: <?php echo $system_preference_items['current_stock_cal_kg']?0:1;?>,aggregates: [{ 'total':aggregates}],aggregatesrenderer:aggregatesrenderer}
                ]
            });
    });
</script>
