        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_DATE_RECEIVE'); ?>', filtertype: 'list',dataField: 'date_receive',width:'80',hidden: <?php echo $system_preference_items['date_receive']?0:1;?>},
