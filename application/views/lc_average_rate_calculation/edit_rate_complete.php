                ...
                <table class="table table-bordered">
                    ...
                    foreach($items as $variety_ifo)
                    {
                        ...
                        <tr>
                            ...
                            <td class="text-center"> <label><?php echo System_helper::get_string_amount($rates[$variety_ifo['variety_id']][$variety_ifo['pack_size_id']]['complete_total_rate_weighted_complete']); ?></label></td>
                            <td class="text-center"> <label><?php echo System_helper::get_string_amount($rates[$variety_ifo['variety_id']][$variety_ifo['pack_size_id']]['complete_total_rate_weighted_complete_calculated']);?></label></td>
                            <td>
                                <input type="text" name="items[<?php echo $variety_ifo['id'];?>][rate_weighted_complete]" class="form-control float_type_positive" value="" />
                            </td>
                        </tr>
                    <?php
                    }
