        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_QUANTITY_TOTAL_PIECES'); ?>', dataField: 'quantity_total_pieces',width:'200',cellsalign: 'right',hidden: <?php echo $system_preference_items['quantity_total_pieces']?0:1;?>},
