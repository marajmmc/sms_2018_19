        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns:
                    [
                        ...
                        { text: '<?php echo $CI->lang->line('LABEL_DATE_FORWARDED_TIME'); ?>', dataField: 'date_forwarded_time',width:200, hidden: <?php echo $system_preference_items['date_forwarded_time']?0:1;?>},
                        { text: '<?php echo $CI->lang->line('LABEL_DATE_RELEASED_TIME'); ?>', dataField: 'date_released_time',width:200, hidden: <?php echo $system_preference_items['date_released_time']?0:1;?>},
                        ...
                        { text: '<?php echo $CI->lang->line('LABEL_DATE_RECEIVED_TIME'); ?>', dataField: 'date_received_time',width:200, hidden: <?php echo $system_preference_items['date_receive']?0:1;?>},
                        { text: '<?php echo $CI->lang->line('LABEL_DATE_COMPLETED_TIME'); ?>', dataField: 'date_completed_time',width:200, hidden: <?php echo $system_preference_items['date_completed_time']?0:1;?>},
